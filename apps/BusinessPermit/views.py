...
def edit_business_permit(request, id):
    if request.user.is_authenticated:
        ...
        if request.method == "POST":
            ...
            Transaction ID: {business_permit.transaction_id}
            You can track your document status anytime at: {request.build_absolute_uri('/document_tracker/')}?txn={business_permit.transaction_id}
